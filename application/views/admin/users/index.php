            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <div class="box-tools">
                            <button type="button" class="btn btn-success modal-users" data-toggle="modal" data-target="#modal-users" data-url="<?= base_url('index.php/Admin/addUsers'); ?>" data-post-url="<?= base_url('index.php/Admin/TambahUsers'); ?>">
                            ...
                            <tbody>
                                ...
                                foreach ($users as $list) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-primary modal-users" data-toggle="modal" data-target="#modal-users" data-url="<?= base_url('index.php/Admin/editUsers/' . $list['id_users']); ?>" data-post-url="<?= base_url('index.php/Admin/UbahUsers'); ?>">
                                                <i class="fa fa-pencil"></i> <span>Edit</span>
                                            </button>
                                            <button type="button" class="btn btn-danger modal-users" data-toggle="modal" data-target="#modal-users" data-url="<?= base_url('index.php/Admin/deleteUsers/' . $list['id_users']); ?>" data-post-url="<?= base_url('index.php/Admin/HapusUsers'); ?>">

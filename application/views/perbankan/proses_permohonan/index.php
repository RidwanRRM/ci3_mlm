								...
								?>
									<thead>
										<tr class="active">
											...
											<th rowspan="2" class="fixed-side" style="width: 200px">NO AGUNAN</th>
										...
										?>
											<tr>
												<td class="fixed-side action-button">
													<button type="button" class="btn btn-primary modal-approve" data-toggle="modal" data-target="#modal-approve" data-url="<?= base_url('index.php/perbankan/setApproval/' . $list['id']); ?>" data-post-url="<?= base_url('index.php/perbankan/setProsesApproval'); ?>">
												...
												<td><?php
													...
													?></td>
												<td><?= $list['tgl_covernote']; ?></td>
												<td><?= $list['no_covernote']; ?></td>
											</tr>
										<?php
											$i++;
										endforeach;

			...
			<div class="col-md-12">
				<div class="box box-default">
					...
					<div class="form-horizontal">
						<form action="<?= base_url('index.php/perbankan/monitoring'); ?>" method="post">
							<div class="box-body">
										...
										<th width="300px" colspan="2">
											<select class="form-control" id="notaris" name="notaris">
												...
												<?php foreach ($notaris as $a) : ?>
													<option value="<?= $a['username']; ?>" <?php if (set_value('username') == $a['username']) echo 'selected'; ?>><?= $a['nama']; ?></option>
												<?php endforeach; ?>
											</select>
										</th>
									</tr>
								...
								?>
									<thead>
										<tr class="active">
											...
											<th rowspan="2" class="fixed-side" style="width: 200px">NOTARIS</th>
									...
									<tbody>
										...
										?>
											<tr>
												...
												<td class="fixed-side"><?= $list['nama']; ?></td>

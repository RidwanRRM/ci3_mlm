...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> <span>Registrasi Member</span>
        </h1>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <div class="box-tools">
                            <button type="button" class="btn btn-success modal-permohonan" data-toggle="modal" data-target="#modal-permohonan" data-url="<?= base_url('index.php/Admin/tree_view'); ?>">
                                <i class="fa fa-tree"></i> <span>Tree View</span>
                            </button>
                            ...
                            <tbody>
                                ...
                                foreach ($users as $list) : ?>
                                    <tr>
                                        ...
                                        <td>Level <?= $list['parent_level']; ?></td>
                                        <td>
                                            <button type="button" class="btn btn-primary modal-users" data-toggle="modal" data-target="#modal-users" data-url="<?= base_url('index.php/Admin/editMember/' . $list['id_users']); ?>" data-post-url="<?= base_url('index.php/Admin/UbahMember'); ?>">
                                                <i class="fa fa-pencil"></i> <span>Edit</span>
                                            </button>
                                            <button type="button" class="btn btn-danger modal-users" data-toggle="modal" data-target="#modal-users" data-url="<?= base_url('index.php/Admin/deleteMember/' . $list['id_users']); ?>" data-post-url="<?= base_url('index.php/Admin/HapusMember'); ?>">
...
<div class="modal fade" id="modal-permohonan" role="dialog">

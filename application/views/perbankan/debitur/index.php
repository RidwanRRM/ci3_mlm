            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header">
                        <div class="box-tools">
                            <button type="button" class="btn btn-success modal-debitur" data-toggle="modal" data-target="#modal-debitur" data-url="<?= base_url('index.php/Perbankan/addDebitur'); ?>" data-post-url="<?= base_url('index.php/Perbankan/TambahDebitur'); ?>">
                            ...
                            <tbody>
                                ...
                                foreach ($debitur as $list) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-primary modal-debitur" data-toggle="modal" data-target="#modal-debitur" data-url="<?= base_url('index.php/Perbankan/editDebitur/' . $list['id_debitur']); ?>" data-post-url="<?= base_url('index.php/Perbankan/UbahDebitur'); ?>">
                                                <i class="fa fa-pencil"></i> <span>Edit</span>
                                            </button>
                                            <button type="button" class="btn btn-danger modal-debitur" data-toggle="modal" data-target="#modal-debitur" data-url="<?= base_url('index.php/Perbankan/deleteDebitur/' . $list['id_debitur']); ?>" data-post-url="<?= base_url('index.php/Perbankan/HapusDebitur'); ?>">
...
<div class="modal fade" id="modal-debitur" role="dialog">

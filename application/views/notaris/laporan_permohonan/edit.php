...
<div class="modal-header">
	...
	<h4 class="modal-title">Ubah Agunan</h4>
</div>
	...
	<div class="form-group">
		<div class="box-body">
			...
			<div class="form-group <?php form_error('nama_agunan') ? print 'has-error' : '' ?>">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" value="<?= set_value('nama_agunan', $agunan['nama_agunan']); ?>" id="nama_agunan" name="nama_agunan">
			...
			<div class="form-group <?php form_error('no_agunan') ? print 'has-error' : '' ?>">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" value="<?= set_value('no_agunan', $agunan['no_agunan']); ?>" id="no_agunan" name="no_agunan">
			...
			<div class="form-group <?php form_error('jenis_hak') ? print 'has-error' : '' ?>">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" id="jenis_hak" name="jenis_hak" value="<?= set_value("jenis_hak", $agunan['jenis_hak']); ?>"></input>
			...
			<div class="form-group <?php form_error('desa') ? print 'has-error' : '' ?>">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" id="desa" name="desa" value="<?= set_value("desa", $agunan['desa']); ?>"></input>
			...
			<div class="form-group <?php form_error('tgl_surat') ? print 'has-error' : '' ?>">
				...
				<div class="col-sm-8">
					<input type="date" class="datepicker form-control" id="tgl_surat" name="tgl_surat" value="<?= set_value("tgl_surat", $agunan['tgl_surat']); ?>">
			...
			<div class="form-group <?php form_error('no_surat') ? print 'has-error' : '' ?>">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" id="no_surat" name="no_surat" value="<?= set_value("no_surat", $agunan['no_surat']); ?>"></input>
			...
			<div class="form-group <?php form_error('luas') ? print 'has-error' : '' ?>">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" id="luas" name="luas" value="<?= set_value("luas", $agunan['luas']); ?>"></input>
			...
			<div class="form-group <?php form_error('proses') ? print 'has-error' : '' ?>">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" rows="3" id="pihak_terkait" name="proses" value="<?= set_value("proses", $agunan['proses']); ?>"></input>
			...
			<div class="form-group <?php form_error('tgl_covernote') ? print 'has-error' : '' ?>">
				...
				<div class="col-sm-8">
					<input type="date" class="form-control" id="tgl_covernote" name="tgl_covernote" value="<?= set_value("tgl_covernote", $agunan['tgl_covernote']); ?>"></input>
			...
			<div class="form-group <?php form_error('no_covernote') ? print 'has-error' : '' ?>">
				...
				<div class="col-sm-8">
					<input type="text" class="form-control" rows="3" id="no_covernote" name="no_covernote" value="<?= set_value("no_covernote", $agunan['no_covernote']); ?>"></input>

...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            <i class="fa fa-users"></i> <span>Migrasi Member/ Pindah Parent</span>
        </h1>
                            ...
                            <tbody>
                                ...
                                foreach ($users as $list) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-primary modal-users" data-toggle="modal" data-target="#modal-users" data-url="<?= base_url('index.php/Admin/editMigrasi/' . $list['id_users']); ?>" data-post-url="<?= base_url('index.php/Admin/UbahMigrasi'); ?>">

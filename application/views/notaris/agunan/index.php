			...
			<div class="col-md-12">
				<div class="box">
					<div class="box-header">
						...
						<div class="box-header">
							<div class="box-tools">
								<button type="button" class="btn btn-success modal-agunan" data-toggle="modal" data-target="#modal-agunan" data-url="<?= base_url('index.php/notaris/addAgunan'); ?>" data-post-url="<?= base_url('index.php/notaris/TambahAgunan'); ?>">
										...
										?>
											<tr>
												<td class="fixed-side action-button">
													<button type="button" class="btn btn-danger modal-agunan" data-toggle="modal" data-target="#modal-agunan" data-url="<?= base_url('index.php/notaris/deleteAgunan/' . $list['id']); ?>" data-post-url="<?= base_url('index.php/notaris/HapusDataAgunan'); ?>">
														<i class="fa fa-eraser"></i>
													</button>
												</td>
												<td class="fixed-side action-button">
													<button type="button" class="btn btn-primary modal-agunan" data-toggle="modal" data-target="#modal-agunan" data-url="<?= base_url('index.php/notaris/editAgunan/' . $list['id']); ?>" data-post-url="<?= base_url('index.php/notaris/UbahDataAgunan'); ?>">

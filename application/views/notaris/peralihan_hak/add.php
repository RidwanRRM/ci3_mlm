		...
		<div class="row col-sm-12">
			<div class="col-sm-6">
				<div class="form-group <?php form_error('nik_1') ? print 'has-error' : '' ?>">
					...
					<div class="col-sm-8">
						<input type="number" class="form-control" value="<?= set_value('nik_1') ?>" id="nik_1" name="nik_1">
				...
				<div class="form-group <?php form_error('nama_1') ? print 'has-error' : '' ?>">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" value="<?= set_value('nama_1') ?>" id="nama_1" name="nama_1">
				...
				<div class="form-group <?php form_error('tempat_lahir_1') ? print 'has-error' : '' ?>">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" value="<?= set_value('tempat_lahir_1') ?>" id="tempat_lahir_1" name="tempat_lahir_1">
				...
				<div class="form-group <?php form_error('tgl_lahir_1') ? print 'has-error' : '' ?>">
					...
					<div class="col-sm-8">
						<input type="date" class="form-control" value="<?= set_value('tgl_lahir_1') ?>" id="tgl_lahir_1" name="tgl_lahir_1">
				...
				<div class="form-group <?php form_error('alamat_1') ? print 'has-error' : '' ?>">
					...
					<div class="col-sm-8">
						<textarea rows="3" class="form-control" id="alamat_1" name="alamat_1"><?= set_value("alamat_1"); ?></textarea>
				...
				<div class="form-group <?php form_error('status_pekerjaan_1') ? print 'has-error' : '' ?>">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" value="<?= set_value("status_pekerjaan_1"); ?>" id="status_pekerjaan_1" name="status_pekerjaan_1">
				...
				<div class="form-group <?php form_error('tgl_ktp_1') ? print 'has-error' : '' ?>">
					...
					<div class="col-sm-8">
						<input type="date" class="form-control" value="<?= set_value('tgl_ktp_1') ?>" id="tgl_ktp_1" name="tgl_ktp_1">
			...
			<div class="col-sm-6">
				<div class="form-group <?php form_error('nik_2') ? print 'has-error' : '' ?>">
					...
					<div class="col-sm-8">
						<input type="number" class="form-control" value="<?= set_value('nik_2') ?>" id="nik_2" name="nik_2">
				...
				<div class="form-group <?php form_error('nama_2') ? print 'has-error' : '' ?>">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" value="<?= set_value('nama_2') ?>" id="nama_2" name="nama_2">
				...
				<div class="form-group <?php form_error('tempat_lahir_2') ? print 'has-error' : '' ?>">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" value="<?= set_value('tempat_lahir_2') ?>" id="tempat_lahir_2" name="tempat_lahir_2">
				...
				<div class="form-group <?php form_error('tgl_lahir_2') ? print 'has-error' : '' ?>">
					...
					<div class="col-sm-8">
						<input type="date" class="form-control" value="<?= set_value('tgl_lahir_2') ?>" id="tgl_lahir_2" name="tgl_lahir_2">
				...
				<div class="form-group <?php form_error('alamat_2') ? print 'has-error' : '' ?>">
					<label class="col-sm-4 control-label">Alamat*</label>
					<div class="col-sm-8">
						<textarea rows="3" class="form-control" id="alamat_2" name="alamat_2"><?= set_value("alamat_2"); ?></textarea>
				...
				<div class="form-group <?php form_error('status_pekerjaan_2') ? print 'has-error' : '' ?>">
					...
					<div class="col-sm-8">
						<input type="text" class="form-control" value="<?= set_value("status_pekerjaan_2"); ?>" id="status_pekerjaan_2" name="status_pekerjaan_2">
				...
				<div class="form-group <?php form_error('tgl_ktp_2') ? print 'has-error' : '' ?>">
					...
					<div class="col-sm-8">
						<input type="date" class="form-control" value="<?= set_value('tgl_ktp_2') ?>" id="tgl_ktp_2" name="tgl_ktp_2">

...
function LoadTimePickerScript(callback){
	var url =  'http://localhost/E-PKWT/komponen/template/';
	if (!$.fn.timepicker){
		$.getScript(url+'plugins/jquery-ui-timepicker-addon/jquery-ui-timepicker-addon.min.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadBootstrapValidatorScript(callback){
	...
	if (!$.fn.bootstrapValidator){
		$.getScript(url+'plugins/bootstrapvalidator/bootstrapValidator.min.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadDataTablesScripts(callback){
	...
	function LoadDatatables(){
		$.getScript(url+'plugins/datatables/jquery.dataTables.js', function(){
			$.getScript(url+'plugins/datatables/ZeroClipboard.js', function(){
				$.getScript(url+'plugins/datatables/TableTools.js', function(){
					$.getScript(url+'plugins/datatables/dataTables.bootstrap.js', callback);
				});
			});
		});
	}
